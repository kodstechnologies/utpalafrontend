...
import { Prescription, Patient } from '../../Pharmacist/Prescriptions/PatientPrescriptionsModal';
...
const PrescriptionPage: React.FC = () => {
    ...
    const renderActions = (row: Patient) => (
        <div className="flex gap-2">
            <Link to={`/therapist/patient/${row.id}`} className="btn btn-outline-info btn-sm">
                View Details
            </Link>
            {/* <button
                type="button"
