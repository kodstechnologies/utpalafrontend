...
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 2v4m0 16v-4m-7-5H2m20 0h-3m-1-5.5l-2.5 2.5m-3-1l-2.5 2.5m3-1l2.5 2.5M4 12a8 8 0 1 0 16 0A8 8 0 0 0 4 12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
);
...
    item: InventoryItem;
    onBack: () => void;
    // NEW PROP: Function to open the Add Batch modal in the parent
...
const InventoryBatchLog: React.FC<InventoryBatchLogProps> = ({ item, onBack, onAddBatch }) => {
...
            {/* Item Summary Card */}
            <div className="bg-blue-50 dark:bg-blue-950/50 p-4 rounded-lg shadow-inner flex justify-between items-center">
                <div>
