...
const StatusBadge = ({ status }: StatusBadgeProps) => {
  let colorClass = '';
  switch (status) {
    case 'Active': colorClass = 'bg-green-100 text-green-700 dark:bg-green-800 dark:text-green-100'; break;
    case 'Inactive': colorClass = 'bg-red-100 text-green-700 dark:bg-red-700 dark:text-red-100'; break;
    case 'Training': colorClass = 'bg-amber-100 text-amber-700 dark:bg-amber-600 dark:text-amber-100'; break;
    case 'On Leave': colorClass = 'bg-blue-100 text-blue-700 dark:bg-blue-700 dark:text-blue-100'; break;
    default: colorClass = 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-100';
  }
