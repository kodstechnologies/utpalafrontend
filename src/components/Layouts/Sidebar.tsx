                                ...
                                <li className="menu nav-item">
                                    <button type="button" className={`${currentMenu === 'usermanagement' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('usermanagement')}>
                                        <div className="flex items-center">
                                            <IconUsers
                                            className="group-hover:!text-primary shrink-0" />
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark"><NavLink to="/usermanagement">{t('User Management')}</NavLink></span>
                                        </div>
